Ниже — краткие пояснения для каждого переделанного кода: как работает алгоритм, его асимптотика и интуиция, почему получается именно такая оценка.[11]
...
Если нужно, добавлю к каждому коду вначале краткий блок-комментарий с этими тремя пунктами прямо в файлы исходников для удобства сдачи отчёта.[11]
